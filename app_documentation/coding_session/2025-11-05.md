...
### Instructions for Phase 2.2:

1. **Enable Email/Password Auth**:
   - Go to your Supabase project dashboard
   - Click "Authentication" in the left sidebar
   - Under "Providers", enable "Email"
   - No additional configuration needed for email/password

2. **Enable Google OAuth**:
   - In Authentication → Providers, click "Google"
...
3. **Configure Email Templates** (Optional but recommended):
   ...
   - Customize confirmation, password reset, magic link templates if desired
...
- [ ] 3. Set URL configuration (site URL and redirect URLs)
- [ ] 4. Test auth flow in dashboard
- [ ] 5. Note: Return here when Supabase auth is enabled
