...
- [ ] 2. Test signup with validation (client-side)
- [ ] 3. Test email confirmation flow
- [ ] 4. Test signin with email/password
- [ ] 5. Test signin with Google OAuth
- [ ] 6. Test password reset flow
- [ ] 7. Test protected routes (/app/dashboard)
...
- 🔄 **Phase 2.8**: Auth testing (IN PROGRESS)
